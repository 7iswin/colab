...
export default function ChatItem({
  ...
  const formSchema = z.object({
    content: z.string().min(1,{message: "Message is Require" }),
  })
  ...
  const isAdmin = currentMember.id === MemberRole.ADMIN
                              ...
                              <FormItem className="flex-1">
                                <FormControl>
                                  <div className="relative w-full">
                                      <Input 
                                      disabled={isLoading}
                                      className="p-2 bg-zinv-200/90 dark:bg-zinc-700/75 border-none border-0 focus-visible:ring-offset-0 text-zinc-600 dark:text-zinc-200"
